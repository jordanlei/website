...
class ArtRealism extends Component {
  render() {
    const imageItems = [
        {
            src: require("../images/art/thwaites.jpg"),
        ...
        {
            src: require("../images/art/aladdin.jpg"),
        ...
        {
            src: require("../images/art/chris-evans.jpg"),
        ...
        {
            src: require("../images/art/noahcentineo.jpg"),
        ...
        {
            src: require("../images/art/man-digital2.jpg"),
